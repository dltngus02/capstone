...
db_config = {
    ...
    "password": "0000",
    "database": "auto_bill",
    'connection_timeout': 999999 # SQL 연결 시간 최대 설정
}
...
download_path = "C:/Users/leesuhyeon/Desktop/캡스톤 돌아가는거/텔래그램 기능 + 다시 백으로 데이터 전송/Project_Login(수정)/static/img"  

# AI ZIP 파일 데이터 경로 지정해야함 ★
basic_file = 'C:/Users/leesuhyeon/Desktop/과제/캡스톤/cap/Store_Item_Datasets.zip'
...
tbl_name = 'capstone_database1'
# db에 만들 주문table 이름 설정해야함 ★
order_tbl_name = '주문_물건1'
